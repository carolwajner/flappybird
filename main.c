...
int main(void)
{
    ...
    Image tubobaixo = LoadImage("./tubosdebaixo.png");
    ImageResize(&tubobaixo, 100, 900);
    Image tubocima = LoadImage("./tubodecima.png");
    ImageResize(&tubocima, 100, 900);
    Image porcosprite = LoadImage("./spriteporco.gif");
...
void SomPower (void)
{
    som_power = LoadSound("./powerup.mp3");
